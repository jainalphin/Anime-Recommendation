$(function() {
  ...
  $('.movie-button').on('click',function(){
    var my_api_key = '113096a0c7058d06583090da3f850090';
    var title = $('.movie').val();
    if (title=="") {
...
function get_movie_details(anime_id,my_api_key,arr,movie_title) {
  $.ajax({
    type:'GET',
    url:'https://api.jikan.moe/v3/anime/'+anime_id,
...
function get_movie_cast(anime_id,my_api_key){
    cast_ids= [];
    cast_names = [];
    cast_chars = [];
    cast_profiles = [];
